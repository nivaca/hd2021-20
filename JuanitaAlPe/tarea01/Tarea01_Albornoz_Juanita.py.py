...
def reemplazar(datos: str) -> str:
    patrones: list[tuple[str, str, int]] = [
        ...
        (r'<a href="https://doi.org/10.25025/perifrasis202112.24.07".+?>(.+?)</a>', r"\1", re.DOTALL),
        (r'<div class="history">(.+?)</div>', r"\1", re.DOTALL),
        (r'</?div class="core-exomatter".*?>(.*?)', r"\1", re.DOTALL),

        (r'<div class="core-affiliations" .+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="keywords-en" .+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="keywords" .+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div property="name".+?>(.+?)</div>', r"\1", 0),

        
        (r'<div role="doc-biblioentry" .+?>(.+?)</div>', r"-\1", re.DOTALL),
        (r'<div id="R1".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R2".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R3".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R4".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R5".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R6".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R7".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R8".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R9".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R10".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R11".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R12".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R13".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R14".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R15".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R16".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div id="R17".+?>(.+?)</div>', r"\1", re.DOTALL),
        (r'<div class="labeled".+?>(.+?)</div>', r" \1", re.DOTALL), 
        
        (r'<div id="fn1".+?>(.+?)</div>', r"\1", 0),
        (r'<div class="labeled".+?>(.+?)</div>', r"\1", re.DOTALL),
